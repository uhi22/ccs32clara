...
static int encode_dinEVSEChargeParameterType(bitstream_t* stream, struct dinEVSEChargeParameterType*) {
	int grammarID = 64;
	int done = 0;
...
static int encode_dinEVStatusType(bitstream_t* stream, struct dinEVStatusType*) {
	int grammarID = 64;
	int done = 0;
...
static int encode_dinSASchedulesType(bitstream_t* stream, struct dinSASchedulesType*) {
	int grammarID = 64;
	int done = 0;
...
static int encode_dinEVChargeParameterType(bitstream_t* stream, struct dinEVChargeParameterType*) {
	int grammarID = 64;
	int done = 0;
...
static int encode_dinBodyBaseType(bitstream_t* stream, struct dinBodyBaseType*) {
	int grammarID = 64;
	int done = 0;
...
static int encode_dinIntervalType(bitstream_t* stream, struct dinIntervalType*) {
	int grammarID = 64;
	int done = 0;
...
static int encode_dinSessionStopType(bitstream_t* stream, struct dinSessionStopType*) {
	int grammarID = 64;
	int done = 0;
...
static int encode_dinChargingStatusReqType(bitstream_t* stream, struct dinChargingStatusReqType*) {
	int grammarID = 64;
	int done = 0;
...
static int encode_dinEVSEStatusType(bitstream_t* stream, struct dinEVSEStatusType*) {
	int grammarID = 64;
	int done = 0;
...
static int encode_dinEVPowerDeliveryParameterType(bitstream_t* stream, struct dinEVPowerDeliveryParameterType*) {
	int grammarID = 64;
	int done = 0;
