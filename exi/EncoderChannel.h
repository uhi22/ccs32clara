 ...
 *
 */
int encodeNBitUnsignedInteger(bitstream_t* stream, uint32_t nbits, uint32_t val);
 ...
 *
 */
int encodeIntegerBig(bitstream_t* stream, int negative, uint32_t size, uint8_t* data, uint32_t len);
 ...
 *
 */
int encodeStringValue(bitstream_t* stream, exi_value_string_table_t* stringTable, uint32_t namespaceUriID, uint32_t localNameID,
...
int encodeRCSStringValue(bitstream_t* stream, exi_value_string_table_t* stringTable,
		uint32_t namespaceUriID, uint32_t localNameID, exi_rcs_t* rcs, exi_string_value_t* string);
 ...
 *
 */
int encodeCharacters(bitstream_t* stream, exi_string_character_t* chars, uint32_t len);
 ...
 *
 */
int encodeRCSCharacters(bitstream_t* stream, exi_string_character_t* chars, uint32_t len, uint32_t rcsCodeLength, uint32_t rcsSize, const exi_string_character_t rcsSet[]);
 ...
 *
 */
int encodeBytes(bitstream_t* stream, uint8_t* data, uint32_t len);
