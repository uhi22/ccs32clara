 ...
 *
 */
int decodeNBitUnsignedInteger(bitstream_t* stream, uint32_t nbits, uint32_t* uint32);
 ...
 *
 */
int decodeUnsignedIntegerSizeT(bitstream_t* stream, uint32_t* sizeT);
 ...
 *
 */
int decodeUnsignedIntegerBig(bitstream_t* stream, uint32_t size, uint8_t* data, uint32_t* len);
 ...
 *
 */
int decodeIntegerBig(bitstream_t* stream, int* negative, uint32_t size, uint8_t* data, uint32_t* len);
 ...
 *
 */
int decodeStringOnly(bitstream_t* stream, uint32_t len, exi_string_t* s);
 ...
 *
 */
int decodeStringValue(bitstream_t* stream, exi_value_string_table_t* stringTable, uint32_t namespaceUriID, uint32_t localNameID, exi_string_value_t* s);
 ...
 *
 */
int decodeRCSStringValue(bitstream_t* stream, exi_value_string_table_t* stringTable, uint32_t namespaceUriID, uint32_t localNameID, exi_rcs_t* rcs, exi_string_value_t* s);
 ...
 *
 */
int decodeCharacters(bitstream_t* stream, uint32_t len, exi_string_character_t* chars, uint32_t charsSize);
 ...
 *
 */
int decodeRCSCharacters(bitstream_t* stream, uint32_t len, exi_string_character_t* chars, uint32_t charsSize, uint32_t rcsCodeLength, uint32_t rcsSize, const exi_string_character_t rcsSet[]);
 ...
 *
 */
int decodeBytes(bitstream_t* stream, uint32_t len, uint8_t* data);
