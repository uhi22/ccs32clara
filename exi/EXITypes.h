...
typedef struct exiNameTableRuntime {
	...
	/* added entries */
	uint32_t addedUriEntries; /* initially zero */
	uint32_t addedLocalNameEntries; /* initially zero */
...
typedef struct {
	uint32_t namespaceUriID;
	uint32_t localNameID;
	uint32_t numberOfProductions;
